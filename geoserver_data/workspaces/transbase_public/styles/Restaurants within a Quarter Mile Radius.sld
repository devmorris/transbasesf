...
<sld:StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:sld="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml" version="1.0.0">
  <sld:NamedLayer>
    <sld:Name>Restaurants within a Quarter Mile Radius</sld:Name>
    <sld:UserStyle>
      <sld:Name>Restaurants within a Quarter Mile Radius</sld:Name>
      <sld:Title>Restaurants within a Quarter Mile Radius</sld:Title>
      <sld:FeatureTypeStyle>
        <sld:Name>name</sld:Name>
        <sld:Rule>
          <sld:Title>1-15 Restaurants</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>restrnt_cnt_qrt_mle</ogc:PropertyName>
              <ogc:LowerBoundary>
        ...
        <sld:Rule>
          <sld:Title>16-52 Restaurants</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>restrnt_cnt_qrt_mle</ogc:PropertyName>
              <ogc:LowerBoundary>
        ...
        <sld:Rule>
          <sld:Title>53-124 Restaurants</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>restrnt_cnt_qrt_mle</ogc:PropertyName>
              <ogc:LowerBoundary>
        ...
        <sld:Rule>
          <sld:Title>125-232 Restaurants</sld:Title>
          <ogc:Filter>
            <ogc:PropertyIsBetween>
              <ogc:PropertyName>restrnt_cnt_qrt_mle</ogc:PropertyName>
              <ogc:LowerBoundary>
