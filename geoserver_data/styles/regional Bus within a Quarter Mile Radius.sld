...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.1.0" xmlns:xlink="http://www.w3.org/1999/xlink" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:se="http://www.opengis.net/se">
  <NamedLayer>
    <se:Name>Regional Bus within a Quarter Mile Radius</se:Name>
    <UserStyle>
      <se:Name>Regional Bus within a Quarter Mile Radius</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>1-35</se:Name>
          <se:Description>
            <se:Title>1-35</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name> 35- 85</se:Name>
          <se:Description>
            <se:Title> 35-85</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>85- 134</se:Name>
          <se:Description>
            <se:Title> 85-134</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>134-225</se:Name>
          <se:Description>
            <se:Title>134-225</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          <se:Name>225-327</se:Name>
          <se:Description>
            <se:Title>225-327</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
